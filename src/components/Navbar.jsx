...
import { CartContext } from "../context/CartContext";
    ...
    const profileItems = ["My Profile", "Orders", "Wishlist", "Settings", "Sign Out"];
    ...
    return (
        ...
        <div className="navbar-top">
            ...
            <div className="desktop-menu">
                {menuItems.map((item) => (
                <a key={item} href={`#${item.toLowerCase().replace(" ", "-")}`} className="menu-item">
                    {item}
                </a>
                ))}
            </div>
            ...
            {/* Hamburger (Mobile) */}
            {windowWidth <= 1024 && (
                <div className="hamburger-btn" onClick={(e) => { e.stopPropagation(); setMenuOpen(!menuOpen); }}>
        ...
        {windowWidth <= 1024 && menuOpen && (
            ...
            <div className="mobile-menu-items">
                {menuItems.map((item) => (
                <a key={item} href={`#${item.toLowerCase().replace(" ", "-")}`} className="mobile-menu-item">
                    {item}
                </a>
                ))}
                {/* Mobile Cart Link */}
